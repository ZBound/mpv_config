...
def parse_received_data_emby(received_data):
    ...
    is_multiple_episodes = True
    if episodes_info and main_ep_info and episodes_info[-1]['IndexNumber'] == main_ep_info['IndexNumber']:
    ...
    result = dict(
        ...
        is_multiple_episodes=is_multiple_episodes
    )
    return result
